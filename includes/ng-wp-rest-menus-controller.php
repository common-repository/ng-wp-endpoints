 ...
 *
 */
class NGWPRestMenus extends NGWPAbstract implements NGWPInterface
{
     ...
     */
    public function getItemsLocation($request)
    {
     ...
     */
    public function getItemsLocations($request)
    {
        $locations = get_nav_menu_locations();
