...
class NGWPController
{
    ...
    private function includes()
    {
        ...
        if (class_exists('WP_REST_Controller')) {
            ...
            include_once 'includes/ng-wp-rest-custom-post-types-controller.php';
            include_once 'includes/ng-wp-endpoints-add-fields.php';
        }
    }
    ...
    public function addEndpoints()
    {
        ...
        $restCustomPostTypes = new NGWPRestCustomPostTypes();
        $restAddFields = new NGWPRestAddFields();
